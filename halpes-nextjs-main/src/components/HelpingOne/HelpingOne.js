...
import helping from "@/data/helpingOne.json";
    ...
    <section className="helping-one">
      <Container>
        <div className="section-title text-center">
          <span className="section-title__tagline">{helping.tagline}</span>
        ...
        <Row>
          <Col xl={12} lg={12}>
            <div className="helping-one__left">
              {helping.sections.map((section, idx) => (
                <div key={idx}>
                  <h3 className="helping-one__title">
                    {section.title}
                  </h3>
                  {section.paragraphs.map((p, i) => (
                    <p key={i} className="helping-one__text">
                      {p}
                    </p>
                  ))}
                </div>
